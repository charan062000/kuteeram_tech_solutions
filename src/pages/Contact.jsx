...
import { FaAngleDown, FaCheckCircle, FaSpinner } from "react-icons/fa";
  ...
  const sendEmail = async (e) => {
    ...
    emailjs
      .sendForm(
        ...
        "template_7cwdzww", // Replace with your EmailJS Template ID
        form.current,
      ...
      .then(
        (result) => {
          setLoading(false);
          setSuccessMessage("Appoinment Book successfully!"); // Set success message
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-20">
        <div className="md:flex gap-x-24 clear-left md:mb-16 mb-10">
          <div className=" md:mb-0 mb-4">
            <div classNameName="w-fit mx-auto lg:mx-0">
              <Heading heading="Get in Touch" color="bg-pink-100" />
            </div>
            <p className="text-gray-600  text-lg mt-5 font-normal mb-7  lg:text-center text-left">
              At Esha Technology, we’re here to answer your questions, discuss
              your projects, and help you find the right solutions. Whether
              you're interested in our IT services, marketing support, or want
              to explore how we can work together, we’re just a message away.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <form ref={form} onSubmit={sendEmail}>
                    ...
                    <div className="mb-8 relative">
                      ...
                      >
                        ...
                        <option value="On Office Location">
                          On Office Location
                        </option>
                      </select>
            ...
            <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://pagedone.io/asset/uploads/1696245837.png')] ">
              <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                <img
                  src="eshaLogo.png"
                  alt="logo"
                  className="w-72 mb-14 mt-3 mx-auto"
                />
                <a href="tel:8523811173" className="flex items-center mb-6">
                  <svg
                    width="30"
                    height="30"
                    viewBox="0 0 30 30"
                ...
                <a href="javascript:;" className="flex flex-col  mb-6">
                  <div className="flex">
                    <svg
                      width="30"
                      height="30"
                    ...
                    <h5 className="ftext-black text-base font-normal leading-6 ml-5">
                      Loaction
                    </h5>
                  </div>
                  ...
                  <iframe
                    ...
                    className=" rounded shadow-2xl -mr-40 w-full h-28  md:mr-0 mt-1 mt-5"
                  ></iframe>
                </a>
