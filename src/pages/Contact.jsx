        ...
        <div className="md:flex gap-x-24 clear-left md:mb-16 mb-10">
          <div className=" md:mb-0 mb-4">
            ...
            <p className="text-gray-600  text-lg mt-5 font-normal mb-7  lg:text-center text-left">
              At Kuteeram Tech Solutions, we’re here to answer your questions,
              discuss your projects, and help you find the right solutions.
              Whether you're interested in our IT services, marketing support,
              or want to explore how we can work together, we’re just a message
              away.
            </p>
          </div>
        </div>
              ...
              <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                ...
                <a href="javascript:;" className="flex flex-col  mb-6">
                  ...
                  <iframe
                    ...
                    className=" rounded shadow-2xl -mr-40 w-full h-36  md:mr-0 mt-1 mt-5"
                  ></iframe>
                </a>
